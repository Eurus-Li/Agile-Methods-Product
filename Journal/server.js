...
const files = new Map([
  ...
  ['/src/journal.js', ['src/journal.js', 'text/javascript; charset=utf-8']],
  ['/src/journal.css', ['src/journal.css', 'text/css; charset=utf-8']],
]);
...
}).listen(port, '127.0.0.1', () => console.log(`Pip Journal: http://localhost:${port}`));
