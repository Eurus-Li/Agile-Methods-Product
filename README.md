...
Rongrong is a gentle emotional-companion app. This repository currently includes a standalone, all-English **Rongrong Plus commercialization demo**.

## Run locally

Install Node.js 20 or later, then from this repository run:
